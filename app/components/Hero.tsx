...
const Hero = (props: Props) => {
  return (
    <div className="w-[95%] mx-auto flex flex-col justify-center items-center">
      ...
      <div>
        <h1 className="1200px:text-[70px] 1100px:text-[60px]  1000px:text-[50px] 800px:text-[45px] 600px:text-[40px] text-[35px] font-bold pt-2 pb-6 gradient-text  text-center ">
      ...
      <div className="">
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-[290px]">
            <ScrollArea className="h-[168px] rounded-md">
