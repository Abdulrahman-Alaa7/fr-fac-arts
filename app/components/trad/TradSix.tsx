  ...
  return (
    <div>
      ...
      <div className="three  bg-[#f2f2f2] dark:bg-background p-2 rounded-md">
        ...
        <p className="ar">
          عندما یمكن ان نلمس جراحنا القدیمة بقلم، دون أن نتألم مرة أخري.
        </p>
        <p className="fr">
          une fois que nous pouvions regarder derrière nous sans nostalgie, ni
          folie, ni rancune.
        </p>
        <p className="ar">
          عندما نقدر علي النظر خلفنا دون حنین، دون جنون، ودون حقد ایضاً.
        </p>
        <p className="fr">Mais est-ce vraiment possible?</p>
        <p className="ar">أیمكن ھذا حقا ؟</p>
        <p className="fr">On ne guérit pas de son passé.</p>
        ...
        <p className="fr">Ahlam Mostaghanmi, La mémoire du corps, p.7.</p>
        <p className="ar">
          أحلام مستغانمي ذاكرة الجسد، دار الآداب، بیروت، ۱۹۹۷ ، ص ۷
        </p>
      </div>
    </div>
  );
