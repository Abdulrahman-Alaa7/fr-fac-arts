  ...
  return (
    <div>
      <div className="one bg-[#f2f2f2] dark:bg-background p-2 rounded-md">
        ...
        <p className="ar">
          كان یا مكان في منتصف الستینات رجل یكافح ویشقى لیبقى عادیا.
        </p>
        <div className="box">
          <p className="fr">
            Par normal, il entendait marié. Marié une seule et bonne fois pour
            toutes.
          </p>
        </div>
        <p className="ar">
          وأن یكون عادیا یعني بالنسبة إلیه أن یكون متزوجا،ً زیجة واحدة وللأبد.
        </p>
        <div className="box">
          <p className="fr">
        ...
        <p className="ar">
          وأن یكون عادیا یعني بالنسبة إلیه أن یعیش حیاة تختلف تماما عن حیاة
          أجداده الذین عاشوا قصص حبٍ مضطربة ومتضاربة ومؤلمة إلى حد لا یطاق.
        </p>
        <div className="box">
          <p className="fr">
            Pour mener à bien ce grand projet de normalité, il avait entouré son
            propre mariage des plus vigilantes protections.
          </p>
        </div>
        <p className="ar">
          ولكي ینجح في ھذا المشروع التطبیعي الكبیر، فقد عمل على ضمان دوام زواجه
          بكل تدابیر الحیاة الفائقة .
        </p>
        <div className="box">
          <p className="fr">
        ...
        <p className="ar">فقطع كل اتصال بأبیه خوفا من العدوى.</p>
        <div className="box">
          <p className="fr">
        ...
        <p className="ar">
          وتوقف عن قراءة الروایات وقلل من مشاھدة الأفلام السینمائیة.
        </p>
        <div className="box">
          <p className="fr">
        ...
        <p className="ar">
          ولكي یتفادى كل خطر، فلقد حرص على الإبتعاد عن الأماكن التي تجعل النفس
          تشتاق للرحیل كالمكتبات المتخصصة في الإبحار والمتاجر المتخصصة في العجیب
        ...
        <p className="ar">ولم یبُقِ في منزله أي خارطة تزین الجدران.</p>
        <div className="box">
          <p className="fr">
        ...
        <p className="ar">
          لكن حلیفه الأساسي والصانع الیومي لسعادته القارةٍ الھادئة كان عمله، تلك
          المھنة التي اختارھا : أي ھندسة الحدائق وخلق المناظر الطبیعیة.
        </p>
        <div className="box">
          <p className="fr">
        ...
        <p className="ar">
          إریك أورسینا ، دائماً وابداً ، باریس ، فایارد ، ۱۹۹۸ ، ص. ۱٥
        </p>
      </div>
    </div>
  );
