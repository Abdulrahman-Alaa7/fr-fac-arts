    ...
    <div>
      <div className="fourteen bg-[#f2f2f2] dark:bg-background p-2 rounded-md">
        ...
        <p className="fr">
          ...
          reconnais-tu ce monsieur-là ? La vieille mercière regarda le grand
          gaillard, chercha dans ses souvenirs et ne trouva rien. Thérèse
          suivait cette scène d’un air placide. – Comment ! reprit Camille, tu
          ne reconnais pas Laurent, le petit Laurent, le fils du père Laurent
          qui a de si beaux champs de blé du côté de Jeufosse ?... Tu ne te
          rappelles pas ?... J’allais à l’école avec lui ; il venait me chercher
        ...
        <p className="fr">
          ...
          important, cette administration ! Le jeune homme fit cette remarque,
        ...
        <p className="fr">
          ...
          regardait le nouveau venu. Elle n’avait jamais vu un homme. Laurent,
          grand, fort, le visage frais, l’étonnait. Elle contemplait avec une
          sorte d’admiration son front bas, planté d’une rude chevelure noire,
          ses joues pleines, ses lèvres rouges, sa face régulière, d’une beauté
          sanguine. Elle arrêta un instant ses regards sur son cou ; ce cou
          était large et court, gras et puissant. Puis elle s’oublia à
          considérer les grosses mains qu’il tenait étalées sur ses genoux ; les
          doigts en étaient carrés ; le poing fermé devait être énorme et aurait
          pu assommer un boeuf. Laurent était un vrai fils de paysan, d’allure
        ...
        <p className="fr">
          ...
          frissons lorsque ses yeux rencontraient son cou de taureau. Camille
          étala ses volumes de Buffon et ses livraisons à dix centimes, pour
          montrer à son ami qu’il travaillait, lui aussi. Puis, comme répondant
          à une question qu’il s’adressait depuis quelques instants : – Mais,
        ...
        <p className="fr">
          ...
          forcé, et échangea quelques mots avec Laurent et son mari ; puis elle
        ...
        <p className="fr">
          ...
          pareille monstruosité. – Oui, le cher homme a des idées à lui... Comme
          il est continuellement en procès avec ses voisins, il m’a mis au
          collège, rêvant de trouver plus tard en moi un avocat qui lui
          gagnerait toutes ses causes... Oh ! le père Laurent n’a que des
        ...
        <p className="ar">
          ...
          عدم القيام بأي شيء، والاسترخاء في الخمول والرضا عن كل الأوقات. كان
        ...
        <p className="ar">
          ...
          التحقيق. كان يحلم بحياة مليئة بالمتعة والراحة على الأرائك، والأكل
          والشرب. استمر الحلم حتى وصلته أموال والده. لكن عندما رأى الشاب، الذي
          كان بالفعل في الثلاثينات من عمره، المحنة قريبة، بدأ يفكر؛ حيث شعر
          بالجبن أمام الحرمان، ولن يقبل يومًا دون الحصول على قوت يومه لأجل الفن.
        ...
        <p className="fr">
          ...
          D’ailleurs, il ne paraissait point trop vaniteux comme artiste, il ne
          se désespéra pas outre mesure, lorsqu’il lui fallut jeter les
          pinceaux. Il ne regretta réellement que l’atelier de son camarade de
          collège, ce vaste atelier dans lequel il s’était si voluptueusement
          vautré pendant quatre ou cinq ans. Il regretta encore les femmes qui
          venaient poser, et dont les caprices étaient à la portée de sa bourse.
          Ce monde de jouissances brutales lui laissa de cuisants besoins de
          chair. Il se trouva cependant à l’aise dans son métier d’employé ; il
          vivait très bien en brute, il aimait cette besogne au jour le jour,
          qui ne le fatiguait pas et qui endormait son esprit. Deux choses
          l’irritaient seulement : il manquait de femmes, et la nourriture des
        ...
        <p className="ar">
          ...
          كثيرًا عندما اضطر لرمي الفرشاة. إنما هو الشيء الذي حقا أحزنه هو فقدان
          استوديو أحد أصدقائه في المدرسة، والذي كانت تتيح له الاسترخاء بمتعة
          خلال أربع أو خمس سنوات. كما أنه اشتاق للنساء اللواتي كانوا يستلقين
          للتصوير، واللواتي كانت مزاجياتهن دائماً في متناول جيبه. ترك له هذا
          العالم من المتع الوحشية رغبات حريقة في الجسد. ومع ذلك، كان يشعر
          بالراحة في عمله كموظف؛ حيث كان يعيش بشكل جيد كحيوان، وكان يحب هذا
          العمل اليومي الذي لم يتعبه والذي كان ينام على عقله. كان هناك شيئان
        ...
        <p className="fr">
          ...
          un singulier effet, reprit Camille avec un rire d’enfant... Moi, je
          serais gêné... La première fois, tu as dû rester tout bête. Laurent
          avait élargi une de ses grosses mains dont il regardait attentivement
          la paume. Ses doigts eurent de légers frémissements, des lueurs rouges
          montèrent à ses joues. – La première fois, reprit-il comme se parlant
          à lui-même, je crois que j’ai trouvé ça naturel... C’est bien amusant,
          ce diable d’art, seulement ça ne rapporte pas un sou... J’ai eu pour
        ...
        <p className="fr">
          ...
          on apercevait des clartés roses dans sa bouche. Elle était comme
          écrasée, ramassée sur elle-même ; elle écoutait. Les regards de
          Laurent allèrent de Thérèse à Camille. L’ancien peintre retint un
          sourire. Il acheva sa phrase du geste, un geste large et voluptueux,
        ...
        <p className="ar">
          ...
          ومنحنية على نفسها، تستمع. وجه لوران تحول بين تيريز وكاميل. حاول الرسام
          السابق احتواء ابتسامته. أكمل عبارته بحركة واسعة وممتعة، تابعتها الشابة
        ...
        <p className="fr">
          ...
          Thérèse resta silencieuse. – Nous sommes en été, reprit Laurent, et
          comme nous sortons du bureau à quatre heures, je pourrai venir ici et
          te faire poser pendant deux heures, le soir. Ce sera l’affaire de huit
          jours. – C’est cela, répondit Camille, rouge de joie ; tu dîneras avec
          nous... Je me ferai friser et je mettrai ma redingote noire. Huit
        ...
        <p className="fr">
          ...
          inconnu sans quelque froideur. Laurent se comporta en bon enfant. Il
          comprit la situation, il voulut plaire, se faire accepter d’un coup.
        ...
        <p className="ar">
          ...
          البرودة. تصرف لوران كطفل جيد. فهم الوضع، وأراد إرضاء الجميع، والفوز
        ...
        <p className="ar">
          ...
          الممتلئة، والروائح الحادة والقوية التي تنبعث من جسده، تضطرب بها الشابة
          وتلقي بها في حالة من القلق العصبي.
        </p>
      </div>
    </div>
  );
