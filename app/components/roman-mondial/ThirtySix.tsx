...
const ThirtySix = (props: Props) => {
  return (
    <div>
      {" "}
      <div className="thirty-five bg-[#f2f2f2] dark:bg-background p-2 rounded-md">
        <div className="heading-ch">
          <h3>الفصل الثاني والثلاثون</h3>
        </div>
        <p className="fr">
          Madame Raquin, sentant que le dénouement était proche, les regardait
        ...
        <p className="fr">
          ...
          menée et qu’ils mèneraient encore, s’ils étaient assez lâches pour
          vivre. Alors, au souvenir du passé, ils se sentirent tellement las et
          écoeurés d’eux-mêmes, qu’ils éprouvèrent un besoin immense de repos,
          de néant.
        </p>
        <p className="ar">
        ...
        <p className="fr">
          ...
          Raquin, froide et muette, les contempla à ses pieds, ne pouvant se
