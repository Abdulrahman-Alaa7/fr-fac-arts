    ...
    <div>
      <div className={`twelve bg-[#f2f2f2] dark:bg-background p-2 rounded-md`}>
        ...
        <p className={`fr`}>
          ...
          menaça de tomber malade, si elle ne cédait pas à son caprice. – Je ne
          t’ai jamais contrariée dans tes projets, lui dit-il ; j’ai épousé ma
          cousine, j’ai pris toutes les drogues que tu m’as données. C’est bien
        ...
        <p className={`ar`}>
          ...
          عليها كسب المزيد من المال، والعودة إلى التجارة، والبحث عن عمل مربح
        ...
        <p className={`fr`}>
          ...
          vaste bureau, avec des manches de lustrine, la plume sur l’oreille.
        ...
        <p className={`ar`}>
          ...
          بعبور باريس، كانت مرعوبة من صخب الشوارع وروعة أرصفة العرض، وهذا الممر
          الضيق والعرض المتواضعة منعتها من تذكر متجرها القديم، الذي كان هادئاً
          جداً. يمكنها أن تعتقد أنها لا تزال في المحافظة، تنفست، وفكرت أن
        ...
        <p className={`fr`}>
          ...
          première année sans entamer sa fortune. Les appointements de Camille
          et les bénéfices du commerce de la mercerie suffiraient, pensait-elle,
          aux besoins journaliers ; de sorte qu’elle ne toucherait plus ses
        ...
        <p className={`ar`}>
          ...
          وأرباح تجارة المحل كافية، كما كانت تفكر، لتلبية الاحتياجات اليومية؛
        ...
        <p className={`fr`}>
          ...
          inappréciables. – Ah ! ma bonne Thérèse, disait-elle, tu verras comme
          nous serons heureuses dans ce coin-là ! Il y a trois belles chambres
        ...
        <p className={`fr`}>
          ...
          Elle regarda la galerie sale et humide, elle visita le magasin, monta
          au premier étage, fit le tour de chaque pièce ; ces pièces nues, sans
          meubles, étaient effrayantes de solitude et de délabrement. La jeune
          femme ne trouva pas un geste, ne prononça pas une parole. Elle était
          comme glacée. Sa tante et son mari étant descendus, elle s’assit sur
        ...
        <p className={`ar`}>
          ...
          المحل وصعدت إلى الطابق الأول وجولت في كل غرفة؛ هذه الغرف العارية، بدون
          أثاث، كانت مخيفة بسبب العزلة والتدهور. لم تجد الشابة أي حركة، ولم تنطق
        ...
        <p className={`fr`}>
          ...
          ne vous ennuierez pas. Jamais le jeune homme n’aurait consenti à
          habiter un pareil taudis, s’il n’avait compté sur les douceurs tièdes
        ...
        <p className={`fr`}>
          ...
          s’étonna de cette attitude affaissée ; elle avait cru que la jeune
        ...
        <p className={`fr`}>
          ...
          elle força sa tante à venir s’asseoir auprès d’elle. Camille resta un
          mois sans pouvoir trouver un emploi. Il vivait le moins possible dans
          la boutique, il flânait toute la journée. L’ennui le prit à un tel
          point, qu’il parla de retourner à Vernon. Enfin, il entra dans
          l’administration du chemin de fer d’Orléans. Il gagnait cent francs
          par mois. Son rêve était exaucé. Le matin, il partait à huit heures.
          Il descendait la rue Guénégaud et se trouvait sur les quais. Alors, à
          petits pas, les mains dans les poches, il suivait la Seine, de
        ...
        <p className={`ar`}>
          ...
          شهرًا دون أن يتمكن من العثور على وظيفة. كان يعيش في المحل قدر الإمكان،
          ويتسكع طوال اليوم. أصابته الملل إلى حد كبير، حتى تحدث عن العودة إلى
          فيرنون. وأخيرًا، دخل في إدارة سكك حديد أورليان. كان يكسب مائة فرنك
          شهريًا. تحقق حلمه. في الصباح، يغادر في الساعة الثامنة. ينزل شارع
          جونيغو ويجد نفسه على الأرصفة. ثم، بخطوات صغيرة، ويديه في جيوبه، يتبع
        ...
        <p className={`fr`}>
          ...
          l’église, alors en réparation, était entourée ; ces grosses pièces de
          charpente l’amusaient, sans qu’il sût pourquoi. Puis, en passant, il
          jetait un coup d’oeil dans le Port aux Vins, il comptait les fiacres
          qui venaient de la gare. Le soir, abruti, la tête pleine de quelque
          sotte histoire contée à son bureau, il traversait le Jardin des
          Plantes et allait voir les ours, s’il n’était pas trop pressé. Il
          restait là une demi heure, penché au dessus de la fosse, suivant du
          regard les ours qui se dandinaient lourdement. Il se décidait enfin à
        ...
        <p className={`ar`}>
          ...
          هذه القطع الكبيرة من الخشب ممتعة له، دون أن يعرف لماذا. ثم، في مروره،
          يلقي نظرة على ميناء الخمور ويعد العربات الكبيرة التي تأتي من المحطة.
          وفي المساء، مشوشًا، ورأسه مليء بأي حكاية سخيفة سمعها في مكتبه، يعبر
          حديقة النباتات ويذهب لرؤية الدببة، إذا لم يكن مستعجلاً. وهناك يبقى
          لمدة نصف ساعة، يميل فوق الحفرة، ويتابع الدببة التي تتدحرج بثقلها.
        ...
        <p className={`fr`}>
          ...
          causait. Il lisait encore, en livraisons à dix centimes, l’Histoire du
          Consulat et de l’Empire, de Thiers, et l’Histoire des Girondins, de
          Lamartine, ou bien des ouvrages de vulgarisation scientifique. Il
        ...
        <p className={`ar`}>
          ...
          يقرأ ما زال، بأجزاء بقيمة عشر سنتات، تاريخ القنصلية والإمبراطورية
          لثيرز، وتاريخ الجيروندين للامارتين، أو كتبًا علمية شائعة. كان يعتقد
          أنه يعمل على تعليم نفسه. في بعض الأحيان، كان يجبر زوجته على الاستماع
          إلى قراءة بعض الصفحات أو بعض الحكايات. كان يستغرب كثيرًا أن تيريز يمكن
        ...
        <p className={`fr`}>
          ...
          abnégation suprêmes. Le commerce allait tout doucement. Les bénéfices,
          chaque mois, étaient régulièrement les mêmes. La clientèle se
          composait des ouvrières du quartier. À chaque cinq minutes, une jeune
          fille entrait, achetait pour quelques sous de marchandise. Thérèse
        ...
        <p className={`ar`}>
          ...
          مطلق. كانت الأعمال تجري ببطء تام. كانت الأرباح، كل شهر، بشكل منتظم
          نفسها. كانت الزبائن يتألفون من عاملات الحي. كل خمس دقائق، تدخل فتاة
        ...
        <p className={`fr`}>
          ...
          une seule fois de son bureau ; sa mère et sa femme sortirent à peine
          de la boutique. Thérèse, vivant dans une ombre humide, dans un silence
          morne et écrasant, voyait la vie s’étendre devant elle, toute nue,
        ...
        <p className={`ar`}>
          ...
          المتجر إلا بالكاد. تيريز، التي كانت تعيش في ظلال رطبة، في صمت مقفر
          ومطحون، كانت ترى الحياة تمتد أمامها، عارية تمامًا، حيث تجلب كل مساء
          نفس الفراش البارد وكل صباح نفس اليوم الفارغ.
        </p>
      </div>
    </div>
  );
